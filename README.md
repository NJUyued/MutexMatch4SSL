...
- `--net [wrn/resnet18/cnn13]` : By default, Wide ResNet (WRN-28-2) are used for experiments. You can use `--widen_factor 8` for WRN-28-8. We provide alternatives as follows: ResNet18 and CNN-13.
